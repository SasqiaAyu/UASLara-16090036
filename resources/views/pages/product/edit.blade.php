                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" name="rasa">
                            <option value="Original" @if($produk->rasa == 'Original'){{"selected"}} @endif>Original</option>
                            <option value="Coklat" @if($produk->rasa == 'Coklat'){{"selected"}} @endif>Coklat</option>
                            <option value="Strawberry" @if($produk->rasa == 'Strawberry'){{"selected"}} @endif>Strawberry</option>
                            <option value="Mocca" @if($produk->rasa == 'Mocca'){{"selected"}} @endif>Mocca</option>
                            <option value="Keju" @if($produk->rasa == 'Keju'){{"selected"}} @endif>Keju</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="last-name" name="harga" required="required" class="form-control col-md-7 col-xs-12" value="{{$produk->harga}}">
                        </div>
                      </div>
                      <div class="form-group">
